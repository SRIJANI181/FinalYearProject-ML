# -*- coding: utf-8 -*-
"""
Created on Wed Jun  8 23:11:12 2022
...
#importing datasets 
cal1_file = pd.read_csv("bomb.tst", sep='\s+', header=None)  # separators longer than 1 character and different from '\s+' will be interpreted as regular expressions and will also force the use of the Python parsing engine
