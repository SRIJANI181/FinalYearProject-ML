# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 10:28:13 2022
...
#importing datasets 
bomb_file = pd.read_csv("bomb.tst", sep='\s+', header=None)

print("\nDataset Description : \n")
print(bomb_file.describe())

print("\nClasses : \n")
print(bomb_file[3].value_counts())

#Extracting Independent and dependent Variable
x = bomb_file.drop(3, axis=1)
y = bomb_file[3]
...
img = bomb_file.drop(3, axis=1).values
